...
/* ---------------------- */
        ...
        var IPSSERVER_update_type   = 'normal';
        var IPSSERVER_download_link = 'http://www.google.com/';
        var IPSSERVER_download_ve   = '71011';
        var IPSSERVER_download_vt   = 'r';
        var IPSSERVER_download_vh       = '2.3.4';
        ...
        var ipsNewsFeed = {
                ...
                var inline            = 1;
                var IPS_KEITH_CONTENT = '<b>Welcome to IPB 2.3.4</b><br><br>    Please keep an eye on this section for any possible issues that may arise in this release.';
		if ( ! inline )
        		{
                		document.write( IPS_KEITH_CONTENT.replace( /&#0039;/g, "'" ) );
        		}
